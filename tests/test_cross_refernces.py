...
def test_invert_cross_reference_table(test_data: dict[int, list[int]], expected: dict[int, int]):
...
def test_find_intersected_cross_references(test_data: dict[int, list[int]], expected: list[tuple[int, int]]):
